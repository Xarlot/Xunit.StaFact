...
namespace Xunit.Sdk
{
    ...
    /// <summary>
    /// The discovery class for <see cref="WinUIFactDiscoverer"/>.
    /// </summary>
    public class WinUIFactDiscoverer : FactDiscoverer
    {
        ...
        protected override IXunitTestCase CreateTestCase(ITestFrameworkDiscoveryOptions discoveryOptions, ITestMethod testMethod, IAttributeInfo factAttribute)
        {
            ...
            return RuntimeInformation.IsOSPlatform(OSPlatform.Windows)
                ? (IXunitTestCase)new UITestCase(UITestCase.SyncContextType.WinUI, this.diagnosticMessageSink, discoveryOptions.MethodDisplayOrDefault(), testMethod)
